"""
EXP-56 H-53-holdout: ONE-SHOT locked-config confirmation, 2023-2026.
...
N_PERMS, SEED = 1000, 87
# ONE-SHOT HOLDOUT: config LOCKED from dev (registry H-53-holdout)
GRID = [{"bottom_exp": 0.0, "bands": (1 / 3, 2 / 3)}]
...
def main() -> int:
    ...
    Path("data/mcpt/exp56_h53_holdout.json").write_text(json.dumps({
