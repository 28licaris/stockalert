...
def _register_background_jobs(
    *,
    ...
    # DISABLED: Backfill gap sweeper job registration
...
async def lifespan(app: FastAPI):
    ...
    # DISABLED: Backfill service causes unwanted Polygon API calls
    backfill_started = None
    logger.info("ℹ️  Backfill service disabled (dev mode)")
    ...
    # DISABLED: Gap sweeper and initial sweep (causes Polygon API calls)
